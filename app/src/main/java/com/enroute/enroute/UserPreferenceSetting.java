...
public class UserPreferenceSetting extends Fragment {
...
//                if(position!=positionbuf){
                    ...
                    Toast.makeText(getActivity(),Preference, Toast.LENGTH_LONG).show();
                return true;
            }
        });
...
////                Preference=selectPosSet.toString();
////                Toast.makeText(getActivity(),Preference, Toast.LENGTH_LONG).show();
//
//
//            }
